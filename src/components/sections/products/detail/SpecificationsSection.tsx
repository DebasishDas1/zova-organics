  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 sm:grid-cols-3">
        <DataCard icon={Package} label="Material" value={product.material} />

        <DataCard icon={Layers3} label="GSM" value={product.gsm} />

        <DataCard icon={Ruler} label="Dimensions" value={product.dimensions} />
      </div>
    </section>
  )
}
