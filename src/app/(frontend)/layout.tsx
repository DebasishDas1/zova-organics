...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: './', // Dynamically resolves to current page instead of forcing '/' globally
    languages: {
      en: 'https://zovaorganics.com',
      fr: 'https://zovaorganics.com?lang=fr',
      de: 'https://zovaorganics.com?lang=de',
      es: 'https://zovaorganics.com?lang=es',
      it: 'https://zovaorganics.com?lang=it',
      ar: 'https://zovaorganics.com?lang=ar',
      ru: 'https://zovaorganics.com?lang=ru',
      tr: 'https://zovaorganics.com?lang=tr',
      'x-default': 'https://zovaorganics.com',
    },
  },
  openGraph: {
    title: 'Zova Organics',
